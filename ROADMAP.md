...
- Owner decision: whether a separate controlled QA mechanism is necessary for live `low_confidence` and `forbidden_authority_fields` scenario verification.
- Keep secrets out of the browser and preserve BIV as the authority before any later controlled live provider call.
- Decide the exact Session 08 starting point after the Session 07 checkpoint; do not start it as part of the checkpoint.
