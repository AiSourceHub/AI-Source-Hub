export const content = {
  en: {
    meta: {
      title: "AI Source Hub | Practical AI products for business decisions",
      description:
        "A premium platform of focused AI decision engines for entrepreneurs and business operators.",
    },
    header: {
      brand: "AI Source Hub",
    ...
    features: {
      ...
      title: "Reusable foundations for every future product.",
      features: [
        {
          icon: "✓",
          title: "Reusable design system",
          copy: "Shared colors, type, spacing, components, and layout rules.",
        },
        {
          icon: "↔",
          title: "Arabic and English support",
          copy: "RTL and LTR-ready components for bilingual product experiences.",
        },
        {
          icon: "◐",
          title: "Dark mode ready",
          copy: "Tokenized colors make future dark interfaces easier to ship.",
        },
        {
          icon: "◎",
          title: "Accessibility ready",
          copy: "Semantic structure, keyboard support, focus states, and readable contrast.",
        },
      ],
    },
    testimonials: {
      eyebrow: "Product principles",
      title: "Built around practical founder outcomes.",
      items: [
        {
          quote:
            "A useful decision product should make the weakest assumption visible quickly.",
          name: "Design principle",
        },
        {
          quote:
            "The result should end with one action the user can begin without extra tools.",
          name: "Product principle",
        },
        {
          quote:
            "Every assessment should reduce uncertainty without pretending to guarantee success.",
    ...
    faq: {
      eyebrow: "FAQ",
      title: "Simple answers for the platform.",
      items: [
        {
