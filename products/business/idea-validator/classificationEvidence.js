...
const conceptDefinitions = [
  ...
  },
  {
    ...
    tokens: ["consulting", "consultancy", "advisory", "bookkeeping", "audit", "auditing"],
    phrases: [
      ["accounting", "advisory"],
      ["accounting", "service"],
      ["bookkeeping", "service"],
    ...
    arTokens: ["استشارة", "استشارات", "استشارية", "تدقيق"],
    arPhrases: [
      ["خدمات", "مهنية"],
      ["مسك", "الدفاتر"],
      ["استشارات", "محاسبية"],
    ...
    sourceFields: ["businessName", "businessIdea", "industry", "competitiveAdvantage"],
  },
  {
