...
assert.equal(prototypePageSource.includes("engineClarificationAnswers"), true);
assert.equal(prototypePageSource.includes("engineClarificationErrors"), true);
assert.equal(prototypePageSource.includes("getEngineClarificationFields"), true);
assert.equal(prototypePageSource.includes("clarificationFlowType === 'feasibility_guided'"), true);
assert.equal(prototypePageSource.includes("clarificationFlowType !== 'feasibility_guided'"), true);
assert.equal(prototypePageSource.includes("industrialDetails: {"), true);
assert.equal(prototypePageSource.includes("...projectedIndustrialDetails"), true);
assert.equal(prototypePageSource.includes("...projectedFeasibilityClarifications"), true);
assert.equal(prototypePageSource.includes("function EngineClarificationField"), true);
assert.equal(prototypePageSource.includes("onEngineClarificationSubmit"), true);
assert.equal(prototypePageSource.includes("onEngineClarificationChange"), true);
assert.equal(prototypePageSource.includes("field.required && !String(engineClarificationAnswers[field.id]"), true);
assert.equal(prototypePageSource.includes("['classification_review', 'classification_correction'].includes(result?.journeyState)"), true);
