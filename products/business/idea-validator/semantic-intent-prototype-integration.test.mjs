...
assert.equal(prototypePageSource.includes("EngineClarificationField"), true);
...
assert.equal(prototypePageSource.includes("classification_review', 'classification_correction"), true);
